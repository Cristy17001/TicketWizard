...
--TICKET
INSERT INTO Ticket (id, user_id, user_assigned_id, department, title, description, status, priority, created_at, updated_at, isClosed) VALUES (1, 2, null, null, 'LLLLL', 'Take ', null, null, '2023-05-16 21:10:31', null, 1);
INSERT INTO Ticket (id, user_id, user_assigned_id, department, title, description, status, priority, created_at, updated_at, isClosed) VALUES (2, 3, null, null, 'Bluescreen', 'After being on my computer for a while it always gets bluescreen.', null, null, '2023-05-16 21:24:40', null, 1);
INSERT INTO Ticket (id, user_id, user_assigned_id, department, title, description, status, priority, created_at, updated_at, isClosed) VALUES (3, 2, null, null, 'Bluescreen', 'o meu computador tem problemas a ligar', null, null, '2023-05-16 21:54:01', null, 1);
INSERT INTO Ticket (id, user_id, user_assigned_id, department, title, description, status, priority, created_at, updated_at, isClosed) VALUES (4, 2, null, 3, 'lol', 'asijdoaisjdqweqwe', null, null, '2023-05-17 10:27:32', null, 1);
INSERT INTO Ticket (id, user_id, user_assigned_id, department, title, description, status, priority, created_at, updated_at, isClosed) VALUES (5, 3, null, 3, 'dasdasdasd', 'dasdasdasdasdsadasdasdasdsadas', null, null, '2023-05-19 10:35:02', null, 1);
INSERT INTO Ticket (id, user_id, user_assigned_id, department, title, description, status, priority, created_at, updated_at, isClosed) VALUES (6, 2, null, null, 'Noa estou a conseguir conectar ao wifi', 'Sempre que tento introduzir a password obtenho um erro, não sei o que se passa', null, null, '2023-05-19 13:08:38', null, 1);
