...
<body>
  <main class="error">
      <h1>Enchanted Error</h1>
      <h2>404 - PAGE NOT FOUND</h2>
      <h3>Looks like there was a hiccup in the Ticket Wizardry.</h3>
      <p>Please hold tight while we conjure up a solution. Contact the developers for assistance.</p>
      <div class="logo">
